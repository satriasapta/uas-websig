...
<body>
    ...
    <div id="sidebar" class="tm-sidebar-left uk-background-default">
        ...
        <ul class="uk-nav uk-nav-default">
            ...
            <li <?php if ($menu == "transportasi") {
                ?> class="uk-active" <?php
                                    } ?>><a href="<?= base_url('administrator/transportasi') ?>"><span data-uk-icon="icon:  world" class="uk-margin-small-right"></span>PETA PEMETAAN</a></li>
